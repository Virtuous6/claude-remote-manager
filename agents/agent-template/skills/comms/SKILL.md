...
<message text>
Reply using: bash "$CRM_TEMPLATE_ROOT/core/bus/send-telegram.sh" <chat_id> "<your reply>"

=== AGENT MESSAGE from <agent> [msg_id: <id>] ===
<message text>
Reply using: bash "$CRM_TEMPLATE_ROOT/core/bus/send-message.sh" <agent> normal '<your reply>' <msg_id>
```
